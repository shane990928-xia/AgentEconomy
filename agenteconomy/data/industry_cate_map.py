industry_cate_map = {
    "category_1_manufacturers": {
      "role": "SKU Producers (Goods)",
      "description": "实体商品生产者。消耗第三类资源，产出具体的 SKU 库存。拥有定价权。",
      "industries": {
        "111CA": "Farms",
    ...
    "category_2_retailers": {
      "role": "SKU Sellers (Channels)",
      "description": "实体商品销售渠道。向第一类进货，面向家庭销售。拥有渠道毛利。",
      "industries": {
    ...
    "category_3_cost_drivers": {
      "role": "Abstract Resource Providers",
      "description": "虚拟资源与服务提供商。不生产 SKU，只提供抽象单位（元/单位）。需要雇佣劳动力。",
      "subgroups": {
        "raw_materials": {
          "description": "基础原材料与上游投入。通常也是全系统的价格锚点。",
          "industries": {
        ...
        "infrastructure_and_services": {
          "description": "运营服务、物流、金融与房地产。作为企业运行的必需成本。",
          "industries": {
            "22": "Utilities",
            "23": "Construction",
        ...
        "government_sectors": {
          "description": "政府服务性收费通道",
          "handling_rule": "注意：这些行业代码仅代表企业/家庭向政府支付的【非税服务费】（如规费、牌照费、公立企业服务费）。资金流向政府 Agent 的账户。真正的【税收】（Tax）和【转移支付】（Redistribution）不通过这些代码，而是由政府 Agent 的税率逻辑独立控制。",
          "industries": {
