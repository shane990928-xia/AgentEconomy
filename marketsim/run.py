...
# Make sure Ray has been initialized with marketsim dir on worker paths
_MARKETSIM_DIR = os.path.dirname(os.path.abspath(__file__))
if not ray.is_initialized():
    ray.init(
        include_dashboard=False,
        runtime_env={
            "working_dir": _MARKETSIM_DIR,
            "env_vars": {
                "PYTHONPATH": _MARKETSIM_DIR + os.pathsep + os.environ.get("PYTHONPATH", ""),
            },
        },
    )
